<template>
  <div class="app-container padding-tabbar">
    ...
    <div class="grow w-full flex flex-col p-4 items-center text-xl">
      ...
      <div class="text-green-700 text-xl mt-3">
        更新让球推导：查找出本赛季主队主场和客队客场都对阵的同一支球队，获取这两场比赛各自的让初和让终，通过两场比赛让初+让初，让终+让终，计算出合理的让初和让终，最后把所有让初和让终取平均值，对比本场的让初和让终。
      </div>
      <a class="mt-3 text-xl block text-left w-full text-blue-600 underline" href="https://t.me/+M1O5yLtJVGpmNmFl">加飞机群讨论</a>
